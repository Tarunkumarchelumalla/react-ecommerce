...
{/*  
        ...
        <TextField variant='standard' color="secondary" label="Enter username" type='text'onChange={(e)=>{setName(e.target.value)}} value={name} ></TextField>
        </div>
        <div className='py-2 w-full flex flex-col'>
        ...
        <div className='py-2 w-full flex flex-col'>
        <TextField variant='standard' color="secondary" label="Confirm Password" onChange={(e)=>{setConpwd(e.target.value)}} value={conpwd} ></TextField>
        </div>
        <div className='py-2 w-full flex flex-col'>
         <Button variant="contained" style={{"backgroundColor":"rgb(6 182 212)",}} className="bg-cyan-300" type="submit">Signup</Button>
          ...
          <div className='flex w-full py-2 justify-center items-center'> 
            ...
            <FaTwitter className='  mx-2  cursor-pointer text-[#1DA1F2] hover:scale-125 duration-300' size={30}/>
             ...
             <Link to="/Login"><p>Already Have an Account??<a className="text-cyan-500 cursor-pointer ">Login</a></p></Link>
