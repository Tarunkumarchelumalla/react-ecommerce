...
function Home({handleclick,username,cartProducts,handleamazon}) {
  ...
  <div className='flex flex-col  mx-auto h-screen max-w-[1100px] px-8 '>
    <div className='text-[#2A2A2A] rounded text-2xl  '>
     ...
     <div className='flex py-4'>
        ...
        <Button variant="contained" color='secondary'style={{"backgroundColor":"rgb(103 232 249)","color":"#2A2A2A"}}>Grab now</Button>
        </Lin>
    ...
    {/* <Home2/> */}
    <Amazonapi handleamazon={handleamazon}/>
